...
class _MapScreenState extends State<MapScreen> {
  ...
  String _distance(Bidet bidet) {
    ...
    final meters = _locationService.distanceBetween(
      ...
      LatLng(bidet.location.latitude, bidet.location.longitude),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<List<Bidet>>(
        stream: _firestoreService.getBidets(),
        builder: (context, snapshot) {
          _bidets = snapshot.data ?? [];
                  ...
                  MarkerLayer(
                    markers: [
                      ...
                      ..._bidets.map((bidet) => Marker(
                            point: LatLng(
                              bidet.location.latitude,
                              bidet.location.longitude,
                            ),
                            width: 36,
                            height: 36,
